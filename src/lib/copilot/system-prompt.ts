...
export async function buildSystemPrompt(
  ...
  return [
    ...
    `- For **VMs**: list_vm_templates shows the site's QEMU templates. VM *creation* isn't a direct tool (it needs ISO/cloud-init choices) — for "create a VM", surface the templates and open_page to /sites/<siteSlug>/deployments/create-vm-from-template so the user completes it in the UI.`,
