        ...
        <header className="flex flex-wrap items-end justify-between gap-4">
          <div>
            ...
            <p className="mt-1 max-w-2xl text-[13px] text-zinc-400">
              Auto-discovered upstream switches, routers, and access points reported
              by Proxmox nodes in this site. Data refreshes when each node&apos;s agent
              posts its 60-second snapshot.
            </p>
          </div>
