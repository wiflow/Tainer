    ...
    <div className="space-y-6">
      ...
      >
        ...
        <label className="block">
          ...
          <input className={inputClassName} name="password" placeholder="Enter a new password" type="password" />
        ...
        <label className="block">
          ...
          <input className={inputClassName} name="confirmPassword" placeholder="Repeat the new password" type="password" />
        </label>
