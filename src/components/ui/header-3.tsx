		...
		>
			<nav className="mx-auto flex h-14 w-full max-w-5xl items-center justify-between px-4">
				<div className="flex items-center gap-5">
					<a href="#" className="hover:bg-accent rounded-md p-2 font-display text-lg font-bold tracking-tight">
						Tainer
					</a>
				...
				<div className="hidden items-center gap-2 md:flex">
					<Button variant="outline" asChild><a href="/login">Sign In</a></Button>
					<Button asChild><a href="/setup">Get Started</a></Button>
				</div>
				<Button
					size="icon"
					variant="outline"
...
const productLinks: LinkItem[] = [
	{
		...
		href: '#',
		description: 'Deploy and manage LXC containers at scale',
		icon: LayersIcon,
	},
	{
		title: 'Template Catalog',
		href: '#',
		description: 'Curated templates for one-click deployments',
		icon: GlobeIcon,
	},
	{
		title: 'Team Access',
		href: '#',
		description: 'Role-based access with 2FA and audit trails',
		icon: UserPlusIcon,
	},
	{
		title: 'Cluster Monitoring',
		href: '#',
		description: 'Real-time CPU, RAM, storage, and network metrics',
		icon: BarChart,
	},
	{
		title: 'Backup & Restore',
		href: '#',
		description: 'Automated backup policies with SLA tracking',
		icon: Shield,
	},
	{
		title: 'Proxmox API',
		href: '#',
		description: 'Direct integration with the Proxmox VE REST API',
		icon: CodeIcon,
	},
];
...
const companyLinks: LinkItem[] = [
	{
		title: "About Tainer",
		href: "#",
		description: "Built for teams managing Proxmox infrastructure",
		icon: Users,
	},
	{
		title: "Case Studies",
		href: "#",
		description: "How teams use Tainer in production",
		icon: Star,
	},
	{
		title: "Open Source",
		href: "#",
		icon: CodeIcon,
		description: "Contribute on GitHub and shape the roadmap",
	},
];
