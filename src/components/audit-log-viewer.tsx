...
const ACTION_META: Record<AdminAuditAction, { category: string; level: Level }> = {
  ...
  "password-reset-completed": { category: "passwords", level: "warning" },
  ...
  "login-password-verified": { category: "logins", level: "info" },
  "two-factor-failure": { category: "2fa", level: "warning" },
  "admin-bootstrapped": { category: "users", level: "warning" },
  "guest-shell-step-up": { category: "2fa", level: "info" },
  "guest-shell-step-up-failure": { category: "2fa", level: "warning" },
